...
def plot(genotype, filename, epoch,pytorch_total_params_train,lambda_a,target,id_a):
  g = Digraph(
      format='png',
  ...
  path = "./result_param_vil/pscore_vil/lambda={}_target={}_id={}/{}/".format(lambda_a,target,id_a,filename)
