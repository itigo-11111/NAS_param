...
def main(genotype = eval("genotypes.%s" % args.arch),layers=20):
# def main():
  # args.limit_param = tar
  # args.layers = layers
  args.img_size = (32, 32)
  args.save = './result_val/ren/layers={}/'.format(args.layers)  
  ...
  # args.arch = "rens" + str(args.layers) 
  # args.arch = "cifar100_net"
  args.arch = "a1500000"
