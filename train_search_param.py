...
# lambda_list = [0.1,0.01,0.001,0.0001,0.00001,0.000001,1,10,100,-0.1]
#init_cannels=16,layers=8
# target_list = [50000,100000,200000,300000,999999] 

#init_cannels=36,layers=20
# target_list = [1500000,2000000,3000000,9999999]
...
def main():
  ...
  args.save = './result/search-{}_{}_target/lambda={}_target={}/'.format(args.save_dir,args.set, args.lambda_a, args.limit_param)
  ...
  for epoch in range(1, args.epochs + 1):
    ...
    vis.plot(genotype.normal, "normal", epoch,pytorch_total_params_train,args.lambda_a,args.limit_param)
    vis.plot(genotype.reduce, "reduce", epoch,pytorch_total_params_train,args.lambda_a,args.limit_param)
    ...
    if not args.val_mode:
      ...
      print('Epoch[{0:03}/{1:03}]  Train Loss:{2:.6f} Train Acc:{3:.6f} Best Train Acc:{4:.6f}  Num of Param:{5} Now {6}'.format(\
